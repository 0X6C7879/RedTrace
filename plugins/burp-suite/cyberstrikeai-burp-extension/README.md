## RedTrace Burp Suite Extension

> Migrated from the CyberStrikeAI Burp Suite extension and managed by
> `RedTrace/plugins/manifest.json`. Connect to `http://127.0.0.1:8000` by
> default; the token is optional unless `REDTRACE_PLUGIN_TOKEN` is configured.
