...
final class CyberStrikeAITab implements ITab {
    ...
    private final JCheckBox useHttpsBox = new JCheckBox("HTTPS", false);
    ...
    private JComponent buildConfigPanel() {
        ...
        row1.add(portField);
        useHttpsBox.setToolTipText("Use https:// for RedTrace (self-signed certs are trusted automatically)");
        row1.add(useHttpsBox);
        row1.add(new JLabel("Token (optional)"));
