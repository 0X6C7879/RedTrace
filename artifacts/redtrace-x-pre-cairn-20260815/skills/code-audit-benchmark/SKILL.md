...
metadata:
  ...
  targetSkill: code-audit-benchmark
  targetModule: code-audit
---
...
**目标 Skill**: code-audit（重点 sast-audit 模式，兼顾其余六种模式）
...
### 目标 Skill 文档
- code-audit 入口: `$REDTRACE_SKILLS_DIR/code-audit/SKILL.md`
- sast-audit 模式: `$REDTRACE_SKILLS_DIR/code-audit/references/modes/sast-audit.md`
