...
| Source code / SAST / PR / MR / API source audit | `code-audit/SKILL.md` (7 modes: arch-scan, api-audit, mr-review, sast-audit, api-inventory, report-review, security-assessment) | deps/CI: `supply-chain-security/`; static finding dynamic verification: `code-audit-runtime-verify/`; FP/FN attribution: `code-audit-benchmark/` |
...
| "code audit / SAST / Semgrep / CodeQL / whitebox / MR review / API inventory" | `code-audit/SKILL.md` |
| "verify static finding / burp verify / runtime confirmation" | `code-audit-runtime-verify/SKILL.md` |
| "benchmark / FP analysis / FN attribution / regression" | `code-audit-benchmark/SKILL.md` |
