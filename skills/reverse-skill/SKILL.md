...
`upstream/RULES.md`, then execute `upstream/skills/SKILL.md` and the matching
...
- At task completion, the same Worker writes the anonymized entry directly to
  `upstream/skills/field-journal/` and updates `_index.md`. Do not submit a
  RedTrace evolution proposal or invoke a separate verification Worker.
