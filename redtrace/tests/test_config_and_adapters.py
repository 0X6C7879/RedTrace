...
def test_pi_driver_models_json_and_execute_argv_include_context_window_and_native_capabilities() -> None:
    ...
    assert models["providers"]["redtrace"]["models"][0]["contextWindow"] == 131072
